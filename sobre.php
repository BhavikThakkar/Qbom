...
<body>
            ...
            <div class="header-wrapper">
                ...
                <ul class="menu">
                    <li>
                        ...
                        <ul class="submenu">
                            <li>
                                ...
                                <ul class="submenu">
                                    <li>
                                        <a href="<?php echo $mainlink; ?>">Mobile App 1</a>
                                    </li>
                                    <li>
                                        <a href="index-2.php">Mobile App 2</a>
                                    </li>
                                    <li>
                                        <a href="index-3.php">Mobile App 3</a>
                                    </li>
                                    <li>
                                        <a href="index-4.php">Mobile App 4</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul class="submenu">
                                    <li>
                                        <a href="index-5.php">Messenger 1</a>
                                    </li>
                                    <li>
                                        <a href="index-6.php">Messenger 2</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul class="submenu">
                                    <li>
                                        <a href="index-7.php">Web 1</a>
                                    </li>
                                    <li>
                                        <a href="index-8.php">Web 2</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul class="submenu">
                                    <li>
                                        <a href="index-9.php">Dextop 1</a>
                                    </li>
                                    <li>
                                        <a href="index-10.php">Dextop 2</a>
                                    </li>
                                    <li>
                                        <a href="index-11.php">Dextop 3</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul class="submenu">
                                    <li>
                                        <a href="index-12.php">Watchapp 1</a>
                                    </li>
                                    <li>
                                        <a href="index-13.php">Watchapp 2</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul class="submenu">
                                    <li>
                                        <a href="index-14.php">Hero Video 1</a>
                                    </li>
                                    <li>
                                        <a href="index-15.php">Hero Video 2</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                <a href="./index-16.php">Home 16 <span class="badge badge-primary align-self-center">New</span></a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="submenu">
                            <li>
                                <a href="feature.php">Feature 1</a>
                            </li>
                            <li>
                                <a href="feature-2.php">Feature 2</a>
                            </li>
                            <li>
                                <a href="feature-3.php">Feature 3</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a href="pricing-plan.php">Pricing</a>
                    </li>
                    <li>
                        <a href="#0">Pages</a>
                        <ul class="submenu">
                            ...
                            <li>
                                <a href="app-download.php">app download</a>
                            </li>
                            <li>
                                <a href="#0">Team</a>
                                <ul class="submenu">
                                    ...
                                    <li>
                                        <a href="team-single.php">Team Single</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul class="submenu">
                            <li>
                                <a href="blog.php">blog style 1</a>
                            </li>
                            <li>
                                <a href="blog-type-two.php">blog style 1</a>
                            </li>
                            <li>
                                <a href="blog-single-1.php">blog Single 1</a>
                            </li>
                            <li>
                                <a href="blog-single-2.php">blog Single 2</a>
                            </li>
                        </ul>
                    </li>
                    <li>
    ...
    <section class="oh creativity-section padding-bottom bg-max-lg-dark bg_img top_center" data-background="./assets/images/feature/experience-bg.png">
        <div class="container">
